...
public class TimeSeriesConfig {
    ...
    public TimeSeriesConfig setMainResolution(long mainResolution) {
        this.mainResolution = mainResolution;
        return this;
    }

    public TimeSeriesConfig setPerMinuteEnabled(boolean perMinuteEnabled) {
        this.perMinuteEnabled = perMinuteEnabled;
        return this;
    }

    public TimeSeriesConfig setHourlyEnabled(boolean hourlyEnabled) {
        this.hourlyEnabled = hourlyEnabled;
        return this;
    }

    public TimeSeriesConfig setDailyEnabled(boolean dailyEnabled) {
        this.dailyEnabled = dailyEnabled;
        return this;
    }

    public TimeSeriesConfig setWeeklyEnabled(boolean weeklyEnabled) {
    ...
    public TimeSeriesConfig setMainFlushInterval(long mainFlushInterval) {
    ...
    public TimeSeriesConfig setFlushSeriesQueueSize(int flushSeriesQueueSize) {
    ...
    public long getFlushOffsetMs() {
        return flushOffsetMs;
    }

    public TimeSeriesConfig setFlushOffsetMs(long flushOffsetMs) {
        this.flushOffsetMs = flushOffsetMs;
        return this;
    }

    public TimeSeriesConfig setPerMinuteFlushInterval(long perMinuteFlushInterval) {
    ...
    public TimeSeriesConfig setHourlyFlushInterval(long hourlyFlushInterval) {
    ...
    public TimeSeriesConfig setDailyFlushInterval(long dailyFlushInterval) {
    ...
    public TimeSeriesConfig setWeeklyFlushInterval(long weeklyFlushInterval) {
    ...
    public static TimeSeriesConfig buildSingleResolutionConfig(long mainResolution, long mainFlushInterval) {
        ...
        return new TimeSeriesConfig()
            ...
            .setMainResolution(mainResolution)
            .setMainFlushInterval(mainFlushInterval)
